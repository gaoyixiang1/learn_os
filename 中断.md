...
​						![image-20231201084706735](.\img\interrupt_7.png))		 
...
![image-20231201095126927](.\img\interrupt_8.png)
...
![image-20231205091838938](.\img\interrupt_9.png)

![image-20231205092034928](.\img\interrupt_10.png)

但是在/dev目录下，我们打印信息，发现并没有主设备号为247的节点，因此这块需要手动创建。执行` mknod /dev/mydemo0 c 247 0`

![image-20231205092513101](.\img\interrupt_11.png)
...
![image-20231205102349503](.\img\interrupt_12.png)
...
![image-20231205100432444](.\img\interrupt_13.png)



![image-20231205100512993](.\img\interrupt_14.png)

创建节点之后，在/dev目录下可以查看到刚才创建的节点

![image-20231205100612742](.\img\interrupt_15.png)
...
![image-20231205100733138](.\img\interrupt_16.png)
